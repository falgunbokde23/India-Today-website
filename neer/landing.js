let upi ="275a3ef2e229e2ba68d1bb451f2e3722"
    ...
    async function advertizing(){
        let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=clothes&countries=in")
    ...
    async function getpoticaldata(){
        ...
        let res =await fetch(`http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=politics&countries=in`)
        let data =await res.json()
    ...
    async function random(){
        let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=random&countries=in")
         let data =await res.json()
    ...
    function appen1(data){
       ...
       async function sport(){
        let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=sport&countries=in")
         let data =await res.json()
    ...
    function append2(data){
       ...
       add()
       async function add(){
        let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=hair&countries=in")
         let data =await res.json()
...
async function opinion(){
    let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=opinion&countries=in")
     let data =await res.json()
...
visual()
       ...
       async function visual(){
        let res=await fetch("http://api.mediastack.com/v1/news?access_key=7fdad13d132e7d86a2480a96cebbee7c&keywords=bollywood&countries=in")
         let data =await res.json()
