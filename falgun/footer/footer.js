function footer(){
    return`    <div id="footerup">
    <h1>INDIATODAY.IN</h1>
    <div id="flexend">
        <h4><i class="fa-brands fa-facebook"></i></h4>
        <h4><i class="fa-brands fa-twitter-square"></i></h4>
        <h4><i class="fa-solid fa-wifi"></i></h4>
