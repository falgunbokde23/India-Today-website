    function navbar(){
        return ` <div id="head_menu">
        <div id="head_container">
            <ul>
                <li><a href="" id="head_today">IndiaToday</a></li>
                <li><a href="" id="head_malayalam">Malayalam</a></li>
                <li><a href="" id="head_business">Business Today</a></li>
                <li><a href="" id="head_daily">Daillyo</a></li>
                <li><a href="" id="head_aajtak">AajTak</a></li>
                <li><a href="" id="head_lallntop">LallanTop</a></li>
                <li><a href="" id="head_bangla">Bangla</a></li>
                <li><a href="" id="head_gnitv">GNITV</a></li>
                <li><a href="" id="head_ichowk">iChowk</a></li>
                <li><a href="" id="head_reader">Reader's Digest</a></li>
